...
//		System.out.println(Htext);
	...
	public void Mypage_Nuticketlist() throws Exception {
		...
		open("http://www.wemakeprice.com/mypage/buylist/unused_refund_result_list");
		String Curl = driver.getCurrentUrl();
		String Htext = $(By.xpath("//h3[contains(.,'미사용티켓 환불신청')]")).getText();
...
//		System.out.println(Htext);
		...
		assertTrue(Html.text.contains(Curl, "http://www.wemakeprice.com/mypage/buylist/unused_refund_result_list")); // URL체크
																														// //
																														// 체크
